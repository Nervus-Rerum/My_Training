...
# Вычисляю среднее арифметическое в каждом элементе списка grades
...
# Сортировка списка students_list по алфавиту
students_list.sort()
# Создание словаря journal
journal = dict(zip(students_list, grades_average))
print(journal)