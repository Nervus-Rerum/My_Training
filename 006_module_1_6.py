...
# Словари
my_dict = {'Alex': 1990, 'Sergey': 1992, 'Artem': 1993}
print("Dict:", my_dict)
print("Existing value:", my_dict.get('Artem'))
print("Not existing value:", my_dict.get('Sasha'))
my_dict.update({'Anya': 1994, 'Natasha': 1995})
a = my_dict.pop('Artem')
print("Deleted value:", a)
print("Modified dictionary:", my_dict)

# Множества
my_set = {1, 1, 2, 3, True, False, True, 'Sasha', 'Alex', 'Sasha'}
print("Set:", my_set)
my_set.update({'Vera', 5})
my_set.remove(True)
