...
print(my_string)
print("Вами введено в строку:", len(my_string), "символа.")
print(my_string .upper(), "- Введённая строка в ВЕРХНЕМ регистре.")
print(my_string .lower(), "- Введённая строка в нижнем регистре.")
print(my_string .replace(" ", ""), "- В введённой строке убраны пробелы.")
print(my_string[0], "- Вывод первого символа введённой строки.")
print(my_string[-1], "- Вывод последнего символа введённой строки.")